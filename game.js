...
choices.forEach((choice) => {
    choice.addEventListener("click", (e) => {
        ...
        let calssToApply = "incorrect";
        if (seleectedAnswer == currentQuestion.answer) {
            calssToApply = "correct";
        }

        console.log(calssToApply);
        ...
        // Ternery op
        // const calssToApply = seleectedAnswer == currentQuestion.answer ? "correct" : "incorrect"

        console.log(seleectedAnswer == currentQuestion.answer);
    });
});
